...
import 'package:cashmate/views/transaction/edit_transaction/widgets/widgets.dart';
...
class _EditTransactionState extends State<EditTransaction> {
  ...
  void initState() {
    ...
    provider.selectedType = widget.obj.type;
    provider.selectedItem = widget.obj.name;
  }
  ...
  Future<void> submitEditTransaction() async {
